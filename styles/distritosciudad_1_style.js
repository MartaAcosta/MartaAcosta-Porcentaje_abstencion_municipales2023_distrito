...
var style_distritosciudad_1 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    var value = feature.get("abstencionp");
    var labelText = "";
    size = 0;
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("abstencionp") !== null) {
        labelText = String(feature.get("abstencionp"));
    }
    if (value >= 23.000000 && value <= 26.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 26.000000 && value <= 31.000000) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 34.000000 && value <= 41.000000) {
            style = [ new ol.style.Style({
